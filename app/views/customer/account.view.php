          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <a href="<?=ROOT?>/customer/account/overview/<?=$row->user_id?>">
                  <li class="nav-item">
                    <button class="nav-link active">Overview</button>
                  </li>
                </a>
  
                <a href="<?=ROOT?>/customer/account/edit/<?=$row->user_id?>">
                  <li class="nav-item">
                    <button class="nav-link" >Edit</button>
                  </li>
                </a>

                <a href="<?=ROOT?>/customer/account/delete/<?=$row->user_id?>">
                  <li class="nav-item">
              ...
              <?php
                 switch ($mode) {
                  ...
                  case 'overview': 
                    $this->view("includes/customer/overview",$data);
                    break;

                  case 'edit': 
                    $this->view("includes/customer/edit",$data);
                    break;

                  case 'delete': 
                    $this->view("includes/customer/delete",$data);
                    break;
